    ...
    return `
        <section>
            ${pageHead(
                ...
                'Знания, которые нужны в работе каждый день',
                'Профессиональная проверка для директоров и специалистов организаций социального обслуживания.'
            )}

            ${showTip
                ? callout('Начните с короткой проверки — она займёт около трёх минут.', { tone: 'info' })
                : ''}
